!(function (a) {
  ...
  function n(e) {
    document.getElementById("header-lang-img") &&
      ...
      a.getJSON("/lang/" + t + ".json", function (e) {
        a("html").attr("lang", t),
  ...
  function c() {
    for (
      var e = document.getElementById("topnav-menu-content").getElementsByTagName("a"),
        t = 0,
        a = e.length;
      t < a;
      t++
  ...
  function r(e) {
    1 == a("#light-mode-switch").prop("checked") && "light-mode-switch" === e
      ? (a("html").removeAttr("dir"),
        ...
        a("#bootstrap-style").attr("href", "/css/bootstrap.min.css"),
        a("body").attr("data-layout-mode", "light"),
        a("#app-style").attr("href", "/css/app.min.css"),
      ...
      ? (a("#light-mode-switch").prop("checked", !1),
        a("#dark-mode-switch").prop("checked", !1),
        a("#dark-rtl-mode-switch").prop("checked", !1),
        a("#bootstrap-style").attr("href", "/css/bootstrap-rtl.min.css"),
        a("#app-style").attr("href", "/css/app-rtl.min.css"),
        a("html").attr("dir", "rtl"),
        a("body").attr("data-layout-mode", "light"),
  ...
  a("#side-menu").metisMenu(),
    ...
    a(document).ready(function () {
      ...
      0 < a("#sidebar-menu").length &&
        ...
        ((e -= 300),
        a(".vertical-menu .simplebar-content-wrapper").animate({ scrollTop: e }, "slow"));
    }),
    ...
    window.sessionStorage &&
      ((e = sessionStorage.getItem("is_visited"))
        ? (a(".right-bar input:checkbox").prop("checked", !1), a("#" + e).prop("checked", !0), r(e))
        : "rtl" === a("html").attr("dir") && "dark" === a("body").attr("data-layout-mode")
        ...
        ? (a("#dark-mode-switch").prop("checked", !0),
          ...
          r(e))
        : sessionStorage.setItem("is_visited", "light-mode-switch")),
    a("#light-mode-switch, #dark-mode-switch, #rtl-mode-switch, #dark-rtl-mode-switch").on(
      "change",
      function (e) {
        r(e.target.id);
      }
